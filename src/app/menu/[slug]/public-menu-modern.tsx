...
export function PublicMenuModern({ hotel, settings, categories, items: initialItems, tableSlug }: Props) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#15161F] flex justify-center">
      ...
      <div
        className={`relative w-full ${FRAME} min-h-screen bg-[#FDFDFD] md:shadow-2xl`}
          ...
          {cartCount > 0 && (
            ...
            >
              <div>
                ...
                <p className="text-white/80 text-xs mt-0.5 font-medium">₹{cartTotal}</p>
              </div>
  ...
  return (
    ...
    >
      <div className="relative w-full aspect-[4/3]">
        ...
        {item.badge && (
          <span
            className="absolute top-2 left-2 text-white text-[10px] font-semibold px-2 py-0.5 rounded-full shadow-md"
            style={{ backgroundColor: themeColor }}
          >
            {item.badge}
          </span>
      ...
      <div className="p-3 flex flex-col flex-1" {...longPress}>
        ...
        {item.description && <p className="text-[11px] text-[#6B7280] mt-1.5 leading-relaxed line-clamp-2">{item.description}</p>}
        {rating && rating.count >= 3 && <RatingStars avg={avg} themeColor={themeColor} count={rating.count} />}
        <p className="text-[15px] font-bold mt-auto pt-2.5" style={{ color: themeColor }}>
          ₹{item.price}
        </p>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="relative w-full aspect-[4/3]">
        ...
        <span
          className="absolute top-2 left-2 flex items-center gap-1 text-white text-[10px] font-semibold px-2 py-0.5 rounded-full shadow-md backdrop-blur-md"
      ...
      <div className="p-3" {...longPress}>
        ...
        <p className="text-[15px] font-bold mt-2" style={{ color: themeColor }}>
          ₹{item.price}
        </p>
      </div>
    </motion.div>
